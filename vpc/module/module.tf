...
resource "aws_subnet" "public" {
  ...
  tags = {
    Name = "test-${element(data.aws_availability_zones.available.names, count.index)}-public"
  }
}
...
resource "aws_instance" "server" {
  ...
  tags = {
    Name = "test-server-${element(data.aws_availability_zones.available.names, count.index)}-${count.index}"
  }
}
